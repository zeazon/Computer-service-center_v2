...
public interface ServiceOrderService {
	...
	public Map<String, Object> selectByCriteria2(String serviceOrderID, String name, String mobileTel, String startDate, String endDate, String type, String serialNo, String employee, String issuePartCode, Integer rows, Integer page, String orderBy, String orderType);
	...
	public List<ServiceOrder> selectSOForCloseByCriteriaIssuePart(String name, String startDate, String endDate, String type, String serialNo, String empFixID, String issuePartCode, Integer rows, Integer page, String orderBy, String orderType);
	public boolean close(ServiceOrder so, List<IssuePart> issuePartList, List<ServiceList> serviceList) throws Exception;
	public List<ServiceOrder> selectFixedSOByCriteria(String name, String date, String type, String issuePartCode, Integer rows, Integer page, String orderBy, String orderType);
