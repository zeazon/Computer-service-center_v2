...
//	private ServiceOrderService soService;
	...
	private String VIEWNAME_M_SEARCH = "sentOutsiteService_m.search";
	private String VIEWNAME_M_FORM = "sentOutsiteService_m.form";
...
//					gridData.setName(new String(os.getCustomerName().getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1));
