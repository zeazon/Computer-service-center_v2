...
<!-- link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jQuery.mmenu/9.1.6/mmenu.min.css" integrity="sha512-TC51O5lYp4Ns3VZC7/N0ZV1pBcG/oLXMeEV5ATWiftiIU48beFD5NFq/S1W/H7fTSQA43YX/vkD4ZxtPDlyj9Q==" crossorigin="anonymous" referrerpolicy="no-referrer" /-->
...
<script src="<%=request.getContextPath()%>/script/mmenu/mmenu.js" type="text/javascript"></script>
<!-- script src="https://cdnjs.cloudflare.com/ajax/libs/jQuery.mmenu/9.1.6/mmenu.js" integrity="sha512-Id7JvMib8xwQrHxPuEglcBH8sxxGGFpZga3IPb7MGf9+NEVl7ysxsA/Di3EyTArLENNJBM5Bu6ZI0lfCcvzQZA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script-->
...
<br />
<!-- button onclick="history.back()" id="backButton" value="<fmt:message key='button.back' />"><fmt:message key='button.back' /></button--><!-- span class="ui-icon ui-icon-circle-arrow-w" style="font-size: 1.4em;" onclick="history.back()"><fmt:message key='button.back' /></span-->
<!-- p class="ui-widget-content ui-state-default ui-helper-clearfix"-->

<!-- div style="border: 2px solid #DDD; width:80px; height:20px;"-->
