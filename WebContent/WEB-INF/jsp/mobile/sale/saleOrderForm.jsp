			...
			<form:form commandName="form" id="form" class="jqtransform" action="saleOrder.html?do=save">
				...
				<table style="width:100%">
					...
					<tr>
						...
						<td><div class="rowElem"><form:input path="saleDate" id="saleDate" class="textboxMockup" size="8" readonly="true"/></div></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3"><div class="rowElem"><span id="address">${fullAddr}&nbsp;</span></div></td>
					</tr>
					<tr>
						<td><label><fmt:message key="productID" />:</label></td>
						<td>
							<div class="rowElem">
								<form:input path="productID" class="textboxMockup" style="float:left" id="productID" readonly="true" size="18" maxlength="20"/> <input type="button" id="productLov" class="lov_button" value="..." >
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><div class="rowElem"><span id="modelTxt">${product.model.name}&nbsp;</span></div></td>
					</tr>
					<tr>
	...
	<form:form commandName="customerForm" id="customerForm" class="jqtransform" action="JavaScript:saveCustomer();">
		<table width="100%">
			<tr>
				...
				<td style="min-width:18ch;"><label><fmt:message key="customerID" />:</label></td>
			...
			<tr>
				...
				<td>
					<div class="rowElem">
						<form:input path="address" id="lovForm_address" class="textboxMockup" style="width:240px" maxlength="255"/><br><br>
						...
						<div style="float:left; margin:5px 0 0 0px;"><fmt:message key="district" />:</div>
						<form:select id="district" path="districtID" items="${districtList}" itemValue="districtID" itemLabel="name">
						</form:select>
						<br><br>
						
						<div style="float:left; margin:5px 0 0 0px;"><fmt:message key="province" />:</div>
