			...
			<form:form commandName="form" id="form" class="jqtransform" action="outsiteService.html?do=save">
				...
				<table style="width:100%">
					<tr>
						...
						<td><div class="rowElem"><form:input path="outsiteServiceID" readonly="true" class="textboxMockup" /></div></td>
					</tr>
					<tr>	
					...
					<tr>
						...
						<td>
							...
							<c:choose>
								<c:when test="${form.status != 'close'}">
									<form:radiobutton path="serviceType" value="warranty" cssStyle="margin-top:4px;" /><label style="float:left; margin-top:4px"><fmt:message key="outsiteServiceServiceType_inWarranty" /></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/><br/><form:radiobutton  path="serviceType" value="repair" cssStyle="margin-top:4px;" /><label style="float:left; margin-top:4px;" ><fmt:message key="outsiteServiceServiceType_outWarranty" /></label>
								</c:when>
								<c:otherwise>
									<form:radiobutton path="serviceType" value="warranty" cssStyle="margin-top:4px;" disabled="true" /><label style="float:left; margin-top:4px"><fmt:message key="outsiteServiceServiceType_inWarranty" /></label><br/><br/><form:radiobutton  path="serviceType" value="repair" cssStyle="margin-top:4px;" disabled="true"/><label style="float:left; margin-top:4px;" ><fmt:message key="outsiteServiceServiceType_outWarranty" /></label>
								</c:otherwise>
							</c:choose>
							</div>
						</td>
					...
					<tr>
						...
						<td><div class="rowElem"><form:input path="customerName" id="customerName" style="width:99%"/></div></td>
					</tr>
					<tr>
						<td><label><fmt:message key="tel" />:</label></td>
						<td><div class="rowElem"><form:input path="tel" id="tel"/></div></td>
					</tr>
					<tr>
						<td><label><fmt:message key="mobileTel" />:</label></td>
						<td><div class="rowElem"><form:input path="mobileTel" id="mobileTel"/></div></td>
					</tr>
					<tr>
						<td colspan="2">
							<div class="rowElem"><br>&nbsp;&nbsp;&nbsp;<b><u><fmt:message key="productDetail" /></u></b></div>
					...
					<tr>
						<td><label><fmt:message key="serialNo" />:</label></td>
						<td><div class="rowElem"><form:input path="serialNo" id="serialNo" /></div></td>
					</tr>
					<tr>
						<td><div class="rowElem"><label><fmt:message key="outsiteService_accessories" />:</label></div></td>
						<td>
							<div class="rowElem">
								<c:choose>
									<c:when test="${form.status != 'close'}">
					...
					<c:choose>
						<c:when test="${form.status == 'close'}">
							<tr>
								...
								<td><div class="rowElem">${form.sentDate}</div></td>
							</tr>
							<tr>
								<td><label><fmt:message key="outsiteService_sentTransportNo" />:</label></td>
								<td><div class="rowElem">${form.sentTransportNo}</div></td>
							</tr>
							<tr>
								<td><label><fmt:message key="outsiteService_receivedDate" />:</label></td>
								<td><div class="rowElem">${form.receivedDate}</div></td>
							</tr>
							<tr>
								<td><label><fmt:message key="transportCompany" />:</label></td>
								<td>
							...
							<tr>
								...
								<td><div class="rowElem">${form.receivedTransportNo}</div></td>
							</tr>
							<tr>
								<td valign="top" style="padding-top:9px;"><label><fmt:message key="outsiteService_repairing" />:</label></td>
								<td align="left"><div class="rowElem"><pre style="font-size:16px; padding-top:4px">${form.repairing}</pre></div></td>
							</tr>
							<tr>
								<td></td>
								<td>
							...
							<tr>
								...
								<td><div class="rowElem">${form.netAmount}&nbsp;<fmt:message key="baht" /></div></td>
							</tr>
							</c:if>
						</c:when>
						<c:otherwise>
							...
							<tr>
								...
								<td><div class="rowElem"><form:input class="required textboxMockup" path="sentTransportNo" /></div></td>
							</tr>
							</c:if>
							<c:if test="${form.status == 'close'}">
							<tr>
								<td><label><fmt:message key="outsiteService_receivedDate" />:<font color="red">*</font></label></td>
								<td><div class="rowElem"><form:input class="required textboxMockup" id="receivedDate" path="receivedDate" readonly="readonly" size="10"/></div></td>
							</tr>
							<tr>
								<td><label><fmt:message key="outsiteService_receivedTransportNo" />:<font color="red">*</font></label></td>
								<td><div class="rowElem"><form:input class="required textboxMockup" path="receivedTransportNo" /></div></td>
							</tr>
							<tr>
								<td valign="top" style="padding-top:9px;"><label><fmt:message key="outsiteService_repairing" />:</label></td>
								<td align="left"><div class="rowElem"><pre style="font-size:16px; padding-top:4px">${form.repairing}</pre></div></td>
...
//			width: 680,
	...
	jQuery("#list").jqGrid({
		...
		colModel:[
			...
			{name:'serviceOrderDate', index:'serviceOrderDate', align:'center', sorttype:'date',formatter:'date', formatoptions: {srcformat:'d/m/Y H:i',newformat:'d/m/Y H:i'}, firstSortOrder:'desc'},
