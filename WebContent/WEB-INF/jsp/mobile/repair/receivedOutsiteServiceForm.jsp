			...
			<form:form commandName="form" id="form" class="jqtransform" action="receivedOutsiteService.html?do=save">
				<table style="width:100%">
					...
					<tr>
						...
						<td><div class="rowElem">${form.refOutsiteJobID}</div></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr>
						...
						<td><div class="rowElem"><form:input class="required textboxMockup" path="receivedTransportNo" maxlength="20" /></div></td>
					</tr>
					<tr>
						<td valign="top" style="padding-top:9px;"><label><fmt:message key="outsiteService_repairing" />:</label></td>
						<td align="left"><div class="rowElem"><form:textarea path="repairing" rows="5" col="28" class="textareaMockup" style="width:94%"></form:textarea><label class="error" for="repairing" generated="true" style="display: none; float:left; padding-left:10px"></label></div></td>
					</tr>
					<tr>
						<td></td>
						<td>
					...
					<tr>
						...
						<td><div class="rowElem"><form:input path="outsiteRepairPrice" id="outsiteRepairPrice" class="number" onBlur="calculateNetAmount();" cssStyle="text-align:right" /><span style="float:left; margin-top:6px">&nbsp;<fmt:message key="baht" /></span><label class="error" for="outsiteRepairPrice" generated="true" style="display: none; padding-left:10px"></label></div></td>
					</tr>
