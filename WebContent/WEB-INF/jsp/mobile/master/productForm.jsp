			...
			<form:form commandName="form" id="form" class="jqtransform" action="product.html?do=save">
				...
				<table width="100%">
					...
					<tr>
						...
						<td><div class="rowElem"><form:textarea path="remark" rows="5" col="30" class="textareaMockup" style="width:96%" name="remark" ></form:textarea></div></td>
					</tr>
					<tr align="center">
	...
	<form:form commandName="modelForm" id="modelForm" class="jqtransform" action="JavaScript:saveModel();">
		<table style="width:100%">
			...
			<tr>
				...
				<td><div class="rowElem"><form:input path="name" id="lovModel_name" cssClass="required" maxlength="100" style="width:100%"/> <label class="error" for="name" generated="true" style="display: none; padding-left:10px"></label></div></td>
			</tr>
			<tr align="center">
				<td colspan="2"><div class="rowElem"><input type="submit" value='<fmt:message key="button.ok" />' /></div></td>
			</tr>
