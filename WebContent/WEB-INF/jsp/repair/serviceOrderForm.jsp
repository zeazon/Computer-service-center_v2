		...
		<tr>
			<td>
				...
				<form id="lovform" class="lov" action="#">
					<table>
						<tr>
							<td style="width:18ch;"><label><fmt:message key="name" />:</label></td>
			...
			<td>
				...
				<form id="productLovForm" class="lov" action="#">
					<table>
						...
						<tr>
							<td><label><fmt:message key="serialNo" />:</label></td>
							<td><div class="rowElem"><input type="text" id="lovSerialNo" class="textboxMockup" size="30"/></div></td>
						</tr>
						<tr>
							<td></td>
...
//	checkCustomerType();	
	...
	jQuery("#list").jqGrid({
		...
		colModel:[
			...
			{name:'name',index:'name', editable:true, width:'370'},
